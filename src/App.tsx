...
function App() {
  ...
  return (
    <div className="py-8 max-w-7xl mx-auto sm:px-6 lg:px-8">
      ...
      {isEasyMode === true ?
        <svg className={isDarkMode ? "w-6 h-6 ml-3 mb-1 invert" : "w-6 h-6 ml-3 mb-1 invert0"}   onClick={() => handleIsEasyMode(!isEasyMode)} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"  
          x="0px" y="0px" viewBox="0 0 120 120"  ><g>
      ...
      :
        ...
        <svg className={isDarkMode ? "w-6 h-6 ml-3 mt-1 invert" : "w-6 h-6 ml-3 mt-1invert0"}   onClick={() => handleIsEasyMode(!isEasyMode)} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"  
