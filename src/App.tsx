...
function App() {
  ...
  return (
    <div className="py-8 max-w-7xl mx-auto sm:px-6 lg:px-8">
      ...
      { isEasyMode == true ?
        <svg className={isDarkMode ? "w-12 h-6 invert" : "w-12 h-6 invert0"}  onClick={() => handleIsEasyMode(!isEasyMode)} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"  
          x="0px" y="0px" viewBox="0 0 850 850"  >
